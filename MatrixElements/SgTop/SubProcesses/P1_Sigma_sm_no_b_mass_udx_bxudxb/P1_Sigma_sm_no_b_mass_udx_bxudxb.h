...
class P1_Sigma_sm_no_b_mass_udx_bxudxb: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_udx_bxudxb(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_udx_bxudxb() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_udx_bxudxb() = delete; 
    ...
    // Matrix elements
    double matrix_1_udx_bxt_no_hz_t_wpb_wp_udx(); 
    double matrix_1_dux_btx_no_hz_tx_wmbx_wm_dux(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_udx_bxudxb >> > mapFinalStates;
