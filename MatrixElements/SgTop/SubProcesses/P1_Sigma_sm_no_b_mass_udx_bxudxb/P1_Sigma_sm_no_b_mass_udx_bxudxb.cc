...
#include <P1_Sigma_sm_no_b_mass_udx_bxudxb.h> 
...
// Process: u d~ > b~ t WEIGHTED<=4 / h z @1
// *   Decay: t > w+ b WEIGHTED<=2
// *     Decay: w+ > u d~ WEIGHTED<=2
// Process: c s~ > b~ t WEIGHTED<=4 / h z @1
// *   Decay: t > w+ b WEIGHTED<=2
// *     Decay: w+ > u d~ WEIGHTED<=2
// Process: u d~ > b~ t WEIGHTED<=4 / h z @1
// *   Decay: t > w+ b WEIGHTED<=2
...
P1_Sigma_sm_no_b_mass_udx_bxudxb::P1_Sigma_sm_no_b_mass_udx_bxudxb(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{-5, 2, -1, 5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_udx_bxudxb::matrix_1_udx_bxt_no_hz_t_wpb_wp_udx, 
      true, 
      {
        std::make_pair(2, -1), std::make_pair(4, -3), std::make_pair(2, -1),
            std::make_pair(4, -3)
      }, 
      64, 
      36
  ...
  mapFinalStates[{5, 1, -2, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_udx_bxudxb::matrix_1_dux_btx_no_hz_tx_wmbx_wm_dux, 
      true, 
      {
        std::make_pair(1, -2), std::make_pair(3, -4), std::make_pair(1, -2),
            std::make_pair(3, -4)
      }, 
      64, 
      36
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_no_b_mass_udx_bxudxb::compute(const std::pair <
...
void P1_Sigma_sm_no_b_mass_udx_bxudxb::calculate_wavefunctions(const int
    perm[], const int hel[])
{
  ...
  oxxxxx(&momenta[perm[2]][0], mME[2], hel[2], +1, w[9]); 
  ixxxxx(&momenta[perm[5]][0], mME[5], hel[5], -1, w[10]); 
  FFV2_2(w[10], w[5], params->GC_100, params->mdl_MT, params->mdl_WT, w[11]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV2_0(w[2], w[7], w[8], params->GC_100, amp[0]); 
  FFV2_0(w[11], w[9], w[8], params->GC_100, amp[1]); 

}
double P1_Sigma_sm_no_b_mass_udx_bxudxb::matrix_1_udx_bxt_no_hz_t_wpb_wp_udx() 
{
...
double P1_Sigma_sm_no_b_mass_udx_bxudxb::matrix_1_dux_btx_no_hz_tx_wmbx_wm_dux() 
{
...
REGISTER_MATRIX_ELEMENT("SgTop_sm_no_b_mass_P1_Sigma_sm_no_b_mass_udx_bxudxb",
    SgTop_sm_no_b_mass::P1_Sigma_sm_no_b_mass_udx_bxudxb);
