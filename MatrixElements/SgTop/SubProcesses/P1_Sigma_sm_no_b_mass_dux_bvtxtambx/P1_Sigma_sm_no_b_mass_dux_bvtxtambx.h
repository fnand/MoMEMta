...
class P1_Sigma_sm_no_b_mass_dux_bvtxtambx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_dux_bvtxtambx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_dux_bvtxtambx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_dux_bvtxtambx() = delete; 
    ...
    // Matrix elements
    double matrix_1_dux_btx_no_hz_tx_wmbx_wm_vtxtam(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_dux_bvtxtambx >> > mapFinalStates;
