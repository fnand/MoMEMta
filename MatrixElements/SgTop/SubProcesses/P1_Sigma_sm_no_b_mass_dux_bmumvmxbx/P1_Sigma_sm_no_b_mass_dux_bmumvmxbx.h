...
class P1_Sigma_sm_no_b_mass_dux_bmumvmxbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_dux_bmumvmxbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_dux_bmumvmxbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_dux_bmumvmxbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_dux_btx_no_hz_tx_wmbx_wm_mumvmx(); 
    double matrix_1_dux_btx_no_hz_tx_wmbx_wm_emvex(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_dux_bmumvmxbx >> > mapFinalStates;
