...
#include <P1_Sigma_sm_no_b_mass_dux_bmumvmxbx.h> 
...
P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::P1_Sigma_sm_no_b_mass_dux_bmumvmxbx(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{5, 11, -12, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::matrix_1_dux_btx_no_hz_tx_wmbx_wm_emvex, 
      true, 
      {
  ...
  mapFinalStates[{5, 13, -14, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::matrix_1_dux_btx_no_hz_tx_wmbx_wm_mumvmx, 
      true, 
      {
        std::make_pair(1, -2), std::make_pair(3, -4)
      }, 
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::compute(const std::pair <
...
void P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::calculate_wavefunctions(const int
    perm[], const int hel[])
{
...
double P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::matrix_1_dux_btx_no_hz_tx_wmbx_wm_mumvmx() 
{
...
double P1_Sigma_sm_no_b_mass_dux_bmumvmxbx::matrix_1_dux_btx_no_hz_tx_wmbx_wm_emvex() 
{
...
REGISTER_MATRIX_ELEMENT("SgTop_sm_no_b_mass_P1_Sigma_sm_no_b_mass_dux_bmumvmxbx", SgTop_sm_no_b_mass::P1_Sigma_sm_no_b_mass_dux_bmumvmxbx); 
