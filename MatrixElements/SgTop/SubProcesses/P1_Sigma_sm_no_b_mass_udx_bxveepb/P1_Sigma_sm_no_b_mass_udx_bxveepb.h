...
class P1_Sigma_sm_no_b_mass_udx_bxveepb: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_udx_bxveepb(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_udx_bxveepb() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_udx_bxveepb() = delete; 
    ...
    std::complex<double> amp[1]; 

    // Matrix elements
    double matrix_1_udx_bxt_no_hz_t_wpb_wp_veep(); 
    double matrix_1_udx_bxt_no_hz_t_wpb_wp_vmmup(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_udx_bxveepb >> > mapFinalStates;
