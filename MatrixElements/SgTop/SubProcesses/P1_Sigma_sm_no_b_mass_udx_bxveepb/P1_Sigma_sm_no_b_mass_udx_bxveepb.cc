...
#include <P1_Sigma_sm_no_b_mass_udx_bxveepb.h> 
...
P1_Sigma_sm_no_b_mass_udx_bxveepb::P1_Sigma_sm_no_b_mass_udx_bxveepb(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{-5, 14, -13, 5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_udx_bxveepb::matrix_1_udx_bxt_no_hz_t_wpb_wp_vmmup, 
      true, 
      {
  ...
  mapFinalStates[{-5, 12, -11, 5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_udx_bxveepb::matrix_1_udx_bxt_no_hz_t_wpb_wp_veep, 
      true, 
      {
        std::make_pair(2, -1), std::make_pair(4, -3)
      }, 
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_no_b_mass_udx_bxveepb::compute(const std::pair <
...
void P1_Sigma_sm_no_b_mass_udx_bxveepb::calculate_wavefunctions(const int
    perm[], const int hel[])
{
...
double P1_Sigma_sm_no_b_mass_udx_bxveepb::matrix_1_udx_bxt_no_hz_t_wpb_wp_veep() 
{
...
double P1_Sigma_sm_no_b_mass_udx_bxveepb::matrix_1_udx_bxt_no_hz_t_wpb_wp_vmmup() 
{
...
REGISTER_MATRIX_ELEMENT("SgTop_sm_no_b_mass_P1_Sigma_sm_no_b_mass_udx_bxveepb",
    SgTop_sm_no_b_mass::P1_Sigma_sm_no_b_mass_udx_bxveepb);
