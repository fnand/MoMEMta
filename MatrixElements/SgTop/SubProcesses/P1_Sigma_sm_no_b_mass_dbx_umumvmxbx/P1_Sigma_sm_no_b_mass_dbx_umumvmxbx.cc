...
#include <P1_Sigma_sm_no_b_mass_dbx_umumvmxbx.h> 
...
P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::P1_Sigma_sm_no_b_mass_dbx_umumvmxbx(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{-1, 11, -12, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_emvex, 
      true, 
      {
  ...
  mapFinalStates[{-1, 13, -14, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_mumvmx, 
      true, 
      {
        std::make_pair(-2, -5), std::make_pair(-4, -5)
      }, 
  ...
  mapFinalStates[{2, 13, -14, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_dbx_utx_no_hz_tx_wmbx_wm_mumvmx, 
      true, 
      {
  ...
  mapFinalStates[{2, 11, -12, -5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_dbx_utx_no_hz_tx_wmbx_wm_emvex, 
      true, 
      {
        std::make_pair(1, -5), std::make_pair(3, -5)
      }, 
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::compute(const std::pair <
...
void P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::calculate_wavefunctions(const int
    perm[], const int hel[])
{
  ...
  FFV2_0(w[7], w[1], w[8], params->GC_100, amp[0]); 
  FFV2_0(w[7], w[1], w[11], params->GC_100, amp[1]); 

}
double P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_dbx_utx_no_hz_tx_wmbx_wm_mumvmx() 
{
...
double P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_mumvmx() 
{
...
double P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_dbx_utx_no_hz_tx_wmbx_wm_emvex() 
{
...
double P1_Sigma_sm_no_b_mass_dbx_umumvmxbx::matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_emvex() 
{
...
REGISTER_MATRIX_ELEMENT("SgTop_sm_no_b_mass_P1_Sigma_sm_no_b_mass_dbx_umumvmxbx", SgTop_sm_no_b_mass::P1_Sigma_sm_no_b_mass_dbx_umumvmxbx); 
