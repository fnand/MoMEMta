...
class P1_Sigma_sm_no_b_mass_dbx_umumvmxbx: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_dbx_umumvmxbx(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_dbx_umumvmxbx() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_dbx_umumvmxbx() = delete; 
    ...
    // Matrix elements
    double matrix_1_dbx_utx_no_hz_tx_wmbx_wm_mumvmx(); 
    double matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_mumvmx(); 
    double matrix_1_dbx_utx_no_hz_tx_wmbx_wm_emvex(); 
    double matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_emvex(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_dbx_umumvmxbx >> > mapFinalStates;
