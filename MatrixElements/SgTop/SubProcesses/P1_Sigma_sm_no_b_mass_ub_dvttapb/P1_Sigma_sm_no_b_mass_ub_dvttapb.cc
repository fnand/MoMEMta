...
#include <P1_Sigma_sm_no_b_mass_ub_dvttapb.h> 
...
P1_Sigma_sm_no_b_mass_ub_dvttapb::P1_Sigma_sm_no_b_mass_ub_dvttapb(const
    ParameterSet& configuration)
{
  ...
  mapFinalStates[{1, 16, -15, 5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_ub_dvttapb::matrix_1_ub_dt_no_hz_t_wpb_wp_vttap, 
      true, 
      {
  ...
  mapFinalStates[{-2, 16, -15, 5}] = 
  {
    {
      &P1_Sigma_sm_no_b_mass_ub_dvttapb::matrix_1_dxb_uxt_no_hz_t_wpb_wp_vttap, 
      true, 
      {
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_no_b_mass_ub_dvttapb::compute(const std::pair <
...
void P1_Sigma_sm_no_b_mass_ub_dvttapb::calculate_wavefunctions(const int
    perm[], const int hel[])
{
...
double P1_Sigma_sm_no_b_mass_ub_dvttapb::matrix_1_ub_dt_no_hz_t_wpb_wp_vttap() 
{
...
double P1_Sigma_sm_no_b_mass_ub_dvttapb::matrix_1_dxb_uxt_no_hz_t_wpb_wp_vttap() 
{
...
REGISTER_MATRIX_ELEMENT("SgTop_sm_no_b_mass_P1_Sigma_sm_no_b_mass_ub_dvttapb",
    SgTop_sm_no_b_mass::P1_Sigma_sm_no_b_mass_ub_dvttapb);
