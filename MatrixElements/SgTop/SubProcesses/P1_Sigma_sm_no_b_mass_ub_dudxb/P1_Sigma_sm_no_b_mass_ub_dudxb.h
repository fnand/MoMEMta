...
class P1_Sigma_sm_no_b_mass_ub_dudxb: public momemta::MatrixElement 
{
  public:

    // Constructor & destructor
    P1_Sigma_sm_no_b_mass_ub_dudxb(const ParameterSet& configuration); 
    virtual ~P1_Sigma_sm_no_b_mass_ub_dudxb() {}; 
  ...
  private:
    ...
    P1_Sigma_sm_no_b_mass_ub_dudxb() = delete; 
    ...
    // Matrix elements
    double matrix_1_ub_dt_no_hz_t_wpb_wp_udx(); 
    double matrix_1_dbx_utx_no_hz_tx_wmbx_wm_dux(); 
    double matrix_1_uxbx_dxtx_no_hz_tx_wmbx_wm_dux(); 
    double matrix_1_dxb_uxt_no_hz_t_wpb_wp_udx(); 

    // map of final states
    std::map < std::vector<int> , std::vector < SubProcess <
        P1_Sigma_sm_no_b_mass_ub_dudxb >> > mapFinalStates;
