...
// Constructor
Parameters_sm_no_b_mass::Parameters_sm_no_b_mass(const SLHA::Reader& card) 
{
...
void Parameters_sm_no_b_mass::cacheParameters()
{
// Define "zero"
zero = 0; 
ZERO = 0; 
...
mdl_MT = m_card_parameters["mdl_MT"]; mdl_conjg__CKM3x3 = 1.; 
mdl_CKM3x3 = 1.; 
mdl_conjg__CKM1x1 = 1.; 
...
void Parameters_sm_no_b_mass::cacheCouplings()
{
GC_100 = (mdl_ee * mdl_complexi * mdl_conjg__CKM1x1)/(mdl_sw * mdl_sqrt__2); 
}

void Parameters_sm_no_b_mass::updateParameters()
{
...
void Parameters_sm_no_b_mass::updateCouplings()
{
